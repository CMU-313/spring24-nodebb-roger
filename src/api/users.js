...
usersAPI.update = async function (caller, data) {
	...
	if (!isAdminOrGlobalModule && meta.config['username:disableEdit']) {
		data.username = oldUserData.username;
	}

	if (!isAdminOrGlobalModule && meta.config['email:disableEdit']) {
...
usersAPI.follow = async function (caller, data) {
	...
	notificationObject.user = userData;
	await notifications.push(notificationObject, [data.uid]);
};
