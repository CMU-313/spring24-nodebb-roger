...
module.exports = {
	...
	async method() {
		...
		const allowGuestSearching = Number.parseInt(meta.config.allowGuestSearching, 10) === 1;
		const allowGuestUserSearching = Number.parseInt(meta.config.allowGuestUserSearching, 10) === 1;
