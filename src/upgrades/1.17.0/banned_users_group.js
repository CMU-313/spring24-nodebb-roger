...
module.exports = {
	...
	async method() {
		...
		const globalModuleCount = await db.sortedSetCard('group:Global Moderators:members');
		...
		await db.setObjectField('group:Global Moderators', 'memberCount', globalModuleCount);
	},
};
